...
* Negotiating on the platform, instead of signing documents back and forth, including a BINSR and contract amendments.
* Signing takes place online, secure codes are radomly generated based on signatures.  Clients will be able to sign without creating a profile.
* The platform will generate filled out documents based on user input, think of tax filing software.
* It fulfills the needs of most transactions, while more complex needs would still require real estate agents and attorneys 
