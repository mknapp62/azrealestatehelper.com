...
<div class="m-3">
     ...
     <div class="shadow col-sm-6 p-3 bg-transparent text-dark border border border-primary rounded">    
      <ul class="list-group">
          ...
          <li class="list-group-item"><div class="form-check">
              ...
              <input class="form-check-input" type="checkbox" id="buyersent" name="sent" value=1 <? echo $_SESSION['sentcheck'] ?>>
              <label class="form-check-label">Contract Sent <img src=https://cdn.jsdelivr.net/npm/bootstrap-icons/icons/patch-question.svg width="20" height="20" id="sentq"><p id="bsent">I have read the entire contract, I fully understand it, and signed it. I have sent my financing pre-qualifiction or proof of funds with the contract</p></label>
            </div></li>

        <li class="list-group-item">
            <h5>Seller Response Before <?php $date = date_create($_SESSION['accepttime']);  echo date_format($date, "m-d-Y h:i:A");?></h5>

              <div class="form-check">
                  <input type="hidden" name="accepted" value=0 />
              <input class="form-check-input" type="checkbox"  name="accepted" value=1 <? echo $_SESSION['acceptedcheck'] ?>>
              <label class="form-check-label">Accepted!</label>
            </div>
              <div class="form-check">

              <input class="form-check-input" type="checkbox"  name="option1" value="something">
              <label class="form-check-label">No response</label>
            </div>

            <button type="button" class="btn btn-primary mb-3" data-bs-toggle="collapse" data-bs-target="#demo" >Counter Offer</button>
            <div id="demo" class="collapse">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="checkbox"  name="option1" value="something">
                  <label class="form-check-label">I'm rejecting</label>
                </div>
    ...
    <div class="shadow col-sm-6 p-3 bg-transparent text-dark border border border-primary rounded">    
      <ul class="list-group">
        ...
        <li class="list-group-item">
            <h5>Buyer Response Before <?php $date = date_create($_SESSION['accepttime']);  echo date_format($date, "m-d-Y h:i:A");?></h5>
 ...
 <div class="container-fluid mt-5 p-5 bg-transparent">
        ...
        <li class="list-group-item">Seller name: <input type="text" class="d-inline-flex bd-highlight rounded-pill"  value="<? echo $_SESSION['seller1']?>" name="seller1" required ></li>
       ...
       <li class="list-group-item"><b>Wastewater:</b><div class="form-check">
          ...
          <button class="btn btn-outline-success" name="updateproperty" value="updateproperty" type="submit">Update Property</button>
                </form>
            </div>
        </div>
</div>
...
<div class="col-md-12 text-center">
 ...
 <div class="container-fluid mt-5 p-5 bg-transparent">
        ...
        <li class="list-group-item">Buyer name: <input type="text" class="d-inline-flex bd-highlight"  value="<? echo $_SESSION['buyer1']?>" name="buyer1" required ></li>
        <li class="list-group-item">Second Buyer name: <input type="text" class="d-inline-flex bd-highlight"  value="<? echo $_SESSION['buyer2']?>" name="buyer2" ></li>
        <li class="list-group-item">Seller name: <input type="text" class="d-inline-flex bd-highlight"  value="<? echo $_SESSION['seller1']?>" name="seller1" required ></li>
        <li class="list-group-item">Seller name: <input type="text" class="d-inline-flex bd-highlight"  value="<? echo $_SESSION['seller2']?>" name="seller2" ></li>
        <li class="list-group-item">Address: <input type="text" class="d-inline-flex bd-highlight"  value="<? echo $_SESSION['address']?>" name="address" ></li>
        <li class="list-group-item">City: <input type="text" class="d-inline-flex bd-highlight"  value="<? echo $_SESSION['city'] ?>" name="city" ></li>
        <li class="list-group-item">County: <input type="text" class="d-inline-flex bd-highlight"  value="<? echo $_SESSION['county'] ?>" name="county" ></li>
        <li class="list-group-item">Zip: <input type="text" class="d-inline-flex bd-highlight"  value="<? echo $_SESSION['zip'] ?>" name="zip" ></li>
        <li class="list-group-item">Assessornum: <input type="text" class="d-inline-flex bd-highlight"  value="<? echo $_SESSION['assessornum']?>" name="assessornum" ></li>
        <li class="list-group-item">Legal Discription: <input type="text" class="d-inline-flex bd-highlight"  value="<? echo $_SESSION['legaldisc']?>" name="legaldisc" ></li>
        <li class="list-group-item">Year Built: <input type="number" class="d-inline-flex bd-highlight"  value="<? echo $_SESSION['yearbuilt']?>" name="yearbuilt" ></li>
...
<?php $inc4 = 11; /* this is the 2+ contracts*/
  ...
  <div class="col">
      ...
      <form action="php/generate.php"  method="get" >
        ...
        <h1>Purchase Contract Summary</h1>
        <li class="list-group-item">Purchase Price: $<input type="number" class="d-inline-flex bd-highlight"  value="'.$_SESSION['purchaseprice' .$inc].'" name="purchaseprice" ></li>
        <li class="list-group-item">Earnest Money: $<input type="number" class="d-inline-flex bd-highlight"  value="'.$_SESSION['earnestmoney' .$inc].'" name="earnestmoney" ></li>
        <li class="list-group-item">Additional Down Payment: $<input type="number" class="d-inline-flex bd-highlight"  value="'.$_SESSION['additionaldown' .$inc].'" name="additionaldown" ></li>
        <li class="list-group-item">Financed Amount: $<input type="number" class="d-inline-flex bd-highlight"  value="'.$_SESSION['financed' .$inc].'" name="financed" ></li>
      ...
      <li class="list-group-item">Close of Escrow Date: <input type="date" class="form-control"  name="coedate" value="'. $_SESSION['coedate' .$inc].'"></li>
      <li class="list-group-item">
      <h5>Addenda:</h5>
    <input type="hidden" name="buyercontingency" value=0 />
      <input type="checkbox" class="form-check-input"  name="buyercontingency" value=1 '. $_SESSION['buyercontingencycheck' .$inc].$_SESSION['disabled' .$inc3].'>
    ...
    <input type="hidden" name="spa" value=0 />
      ...
      <li class="list-group-item">Other Personal Prop: <input type="text" class="d-inline-flex bd-highlight"  value="'. $_SESSION['personalprop' .$inc].'" name="personalprop" ></li>
      <li class="list-group-item">Other Personal Prop: <input type="text" class="d-inline-flex bd-highlight"  value="'. $_SESSION['personalprop2' .$inc].'" name="personalprop2" ></li>
      <li class="list-group-item">Date Toured: <input type="date" class="d-inline-flex bd-highlight"  value="'.$_SESSION['tour' .$inc].'" name="tour" ></li>
    ...
    <li class="list-group-item">
      ...
      <input type="number" class="form-control"  placeholder="Seller Consessions $" name="sellerconsessions" value="'.$_SESSION['sellerconsessionsdollar' .$inc].'">
    </li>
    <li class="list-group-item">
      <h5>Home Warranty Plan May Be Ordered By:</h5>
    ...
    <li class="list-group-item">
      <h5>Seller Must Respond By: </h5>
      <input type="datetime-local" class="form-control"  name="accepttime" value='.date_format($_SESSION['accepttimedate' .$inc], "Y-m-d\TH:i:s").'>
    </li>
      <h1>The Seller Does '.$_SESSION['agentmessage' .$inc].'</h1>
      ...
      <button type="button" class="btn btn-primary mb-3" data-bs-toggle="collapse" data-bs-target="#demo" >Seller Agent</button>
        <div id="demo" class="collapse '.$_SESSION['agentbutton' .$inc].'">
          ...
          <li class="list-group-item">Agent Firm Liscence: <input type="text" class="d-inline-flex bd-highlight"  value="'.$_SESSION['firmlicense' .$inc].'" name="firmlicense" ></li></fieldset>'; 
        if($inc7 == 0){echo '
        <br><button type="submit" name="savechanges" class="btn btn-primary btn-sm" '.$_SESSION['disabled'].'>Save Changes</button>
    
    <br><button type="submit" name="create" class="btn btn-primary btn-lg"'.$_SESSION['disabled'].'>I Accept Create Contract</button></form><br>';}else{echo '</form><br>';}
      ...
      if(!in_array($_SESSION['userview'], ['111', '001'], true) && $inc7 == 0){
       echo '<form action="php/retd.php"  method="post">
             <input type="hidden" name="counter" value="counter"/>
            <button class="btn btn-outline-primary" type="submit" '.$_SESSION['disabled'].'>'.$_SESSION['counterbuttontext'].'</button> </form></div>
...
<div class="col-md-12 text-center">
 ...
 <div class="container-fluid mt-5 p-5 bg-transparent">
       ...
       <li class="list-group-item"><b>Wastewater:</b><div class="form-check">
                <input type="radio" class="form-check-input"  name="wastewater" value="Sewer" '.$_SESSION['sewercheck'].$_SESSION['disabled' .$inc3].'>
                <label class="form-check-label" for="radio1">Sewer</label>
              </div>

              <div class="form-check">
                <input type="radio" class="form-check-input"  name="wastewater" value="Septic" '.$_SESSION['septiccheck'].$_SESSION['disabled' .$inc3].'>
                <label class="form-check-label" for="radio2">Septic</label>
              </div></li><br>
              <input type="hidden" name="updateproperty" value="updateproperty"/>
          <button class="btn btn-outline-success" type="submit">Update Property</button>
                </form>
            </div>
        </div>
</div>
...
if($_SESSION['counter'] == 1 or $_SESSION['counter'] == "counter"){
  ...
  <div class="col">
      ...
      <form action="php/generate.php"  method="get" >
        ...
        <li class="list-group-item">Buyer name: <input type="text" class="d-inline-flex bd-highlight" id="Buyer10" value="' .$_SESSION['buyer1' .$inc].'" name="buyer1" required ></li>
        <li class="list-group-item">Second Buyer name: <input type="text" class="d-inline-flex bd-highlight" id="Buyer20" value="'. $_SESSION['buyer2' .$inc].'" name="buyer2" ></li>
        <li class="list-group-item">Seller name: <input type="text" class="d-inline-flex bd-highlight" id="Seller10" value="'. $_SESSION['seller1' .$inc].'" name="seller1" required ></li>
        <li class="list-group-item">Seller name: <input type="text" class="d-inline-flex bd-highlight" id="Seller20" value="'. $_SESSION['seller2' .$inc].'" name="seller2" ></li>
        <li class="list-group-item">Address: <input type="text" class="d-inline-flex bd-highlight" id="address0" value="'. $_SESSION['address' .$inc].'" name="address" ></li>
        <li class="list-group-item">City: <input type="text" class="d-inline-flex bd-highlight" id="city0" value="'. $_SESSION['city' .$inc].'" name="city" ></li>
        <li class="list-group-item">County: <input type="text" class="d-inline-flex bd-highlight" id="county0" value="'. $_SESSION['county' .$inc].'" name="county" ></li>
        <li class="list-group-item">Zip: <input type="text" class="d-inline-flex bd-highlight" id="zip0" value="'. $_SESSION['zip' .$inc].'" name="zip" ></li>
        <li class="list-group-item">Assessornum: <input type="text" class="d-inline-flex bd-highlight" id="assessornum0" value="'. $_SESSION['assessornum' .$inc].'" name="assessornum" ></li>
        <li class="list-group-item">Legal Discription: <input type="text" class="d-inline-flex bd-highlight" id="legaldisc0" value="'. $_SESSION['legaldisc' .$inc].'" name="legaldisc" ></li>
        <li class="list-group-item">Year Built: <input type="number" class="d-inline-flex bd-highlight" id="yearbuilt0" value="'. $_SESSION['yearbuilt' .$inc].'" name="yearbuilt" ></li>
        
       <li class="list-group-item"><b>Wastewater:</b><div class="form-check">
                <input type="radio" class="form-check-input" id="sewer0" name="wastewater" value="Sewer" '.$_SESSION['sewercheck' .$inc].'>
                <label class="form-check-label" for="radio1">Sewer</label>
              </div>

              <div class="form-check">
                <input type="radio" class="form-check-input" id="septic0" name="wastewater" value="Septic" '.$_SESSION['septiccheck' .$inc].'>
                <label class="form-check-label" for="radio2">Septic</label>
              </div></li><br>
  ...
  <body><h1 id="delete" style="display:none">
    ...
    <div class="mt-4 p-5 bg-primary text-white rounded">
      <h2 id="header">
        ...
        echo "address10: " .$_SESSION['address'];
        echo " user view buyer:seller, created, sent " .$_SESSION['userview'];
...
<?php $inc4 = 11; /* this is the 2+ contracts*/
  ...
  <div class="col">
      ...
      <form action="php/generate.php"  method="get" >
          <fieldset disabled>
        <li class="list-group-item">Buyer name: <input type="text" class="d-inline-flex bd-highlight"  value="' .$_SESSION['buyer1' .$inc].'" name="buyer1" required ></li>
        <li class="list-group-item">Second Buyer name: <input type="text" class="d-inline-flex bd-highlight"  value="'. $_SESSION['buyer2' .$inc].'" name="buyer2" ></li>
        <li class="list-group-item">Seller name: <input type="text" class="d-inline-flex bd-highlight"  value="'. $_SESSION['seller1' .$inc].'" name="seller1" required ></li>
        <li class="list-group-item">Seller name: <input type="text" class="d-inline-flex bd-highlight"  value="'. $_SESSION['seller2' .$inc].'" name="seller2" ></li>
        <li class="list-group-item">Address: <input type="text" class="d-inline-flex bd-highlight"  value="'. $_SESSION['address' .$inc].'" name="address" ></li>
        <li class="list-group-item">City: <input type="text" class="d-inline-flex bd-highlight"  value="'. $_SESSION['city' .$inc].'" name="city" ></li>
        <li class="list-group-item">County: <input type="text" class="d-inline-flex bd-highlight"  value="'. $_SESSION['county' .$inc].'" name="county" ></li>
        <li class="list-group-item">Zip: <input type="text" class="d-inline-flex bd-highlight"  value="'. $_SESSION['zip' .$inc].'" name="zip" ></li>
        <li class="list-group-item">Assessornum: <input type="text" class="d-inline-flex bd-highlight"  value="'. $_SESSION['assessornum' .$inc].'" name="assessornum" ></li>
        <li class="list-group-item">Legal Discription: <input type="text" class="d-inline-flex bd-highlight"  value="'. $_SESSION['legaldisc' .$inc].'" name="legaldisc" ></li>
        <li class="list-group-item">Year Built: <input type="number" class="d-inline-flex bd-highlight"  value="'. $_SESSION['yearbuilt' .$inc].'" name="yearbuilt" ></li>
        
       <li class="list-group-item"><b>Wastewater:</b><div class="form-check">
                <input type="radio" class="form-check-input"  name="wastewater" value="Sewer" '.$_SESSION['sewercheck' .$inc].$_SESSION['disabled' .$inc3].'>
                <label class="form-check-label" for="radio1">Sewer</label>
              </div>

              <div class="form-check">
                <input type="radio" class="form-check-input"  name="wastewater" value="Septic" '.$_SESSION['septiccheck' .$inc].$_SESSION['disabled' .$inc3].'>
                <label class="form-check-label" for="radio2">Septic</label>
              </div></li><br>
