  ...
  <div class="row">
    ...
    <div class="container p-2 my-3 border">
        ...
        <form  action="php/retd.php" method="post">
          ...
          <div class="mb-3">
            <label for="pwd" class="form-label">Password:</label><?php<?php
session_set_cookie_params(0, '/', '.azrealestatehelper.com');
session_start();
...
<div style="display:none"><?php include('php/retd.php');?></div>
 ...
 <div class="d-grid">
  ...
  <div class="row p-3">
   <!--   <div class="col"> -->
    <div class="shadow col-sm p-2 m-1 bg-transparent text-dark border border border-primary border- 5 rounded">
        ...
        <form  action="php/retd.php" method="post">
          <div class="mb-3 mt-3">
            <label for="email" class="form-label">Email:</label>
            <input type="email" class="form-control rounded-pill" id="email" placeholder="Enter email" name="email" required>
          </div>
          <div class="mb-3">
            <label for="pwd" class="form-label">Password:</label>
            <input type="password" class="form-control rounded-pill" id="pwd" placeholder="Enter password" name="pswd" required>
          </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <button name="sendkey" type="submit" id="sendkey" value="sendit!" class="btn btn-outline-primary btn-sm"><h6 id="resettext">Send Key to reset password</h6></button>
                    ...
                    <div class="container p- my-1 border">
...
<div class="shadow col-sm p-2 m-1 bg-transparent text-dark border border border-primary border- 5 rounded">
         ...
         <form action="php/retd.php"  method="post">
            ...
            <input type="number" class="form-control rounded-pill" id="buyerid" placeholder="Enter buyer ID #" name="buyerid" required>
          </div>
           <div class="mb-3">
            <label for="propertyid" class="form-label">Property ID:</label>
            <input type="number" class="form-control rounded-pill" id="propertyid" placeholder="Enter property id #" name="propertyid" required>
          </div>
    ...
    <div class="shadow col-sm p-2 m-1 bg-transparent text-dark border border border-primary border- 5 rounded">
        ...
        <form action="php/retd.php" method="post" id="myform1">
          ...
          <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control rounded-pill" id="name" placeholder="Enter legal name" name="createname" required>
          </div>
          <div class="mb-3">
            <label for="email" class="form-label">Email:</label>
            <input type="email" class="form-control rounded-pill" id="newemail" placeholder="Enter email" name="createemail" required>
          </div>
          <div class="mb-3">
            <label for="pwd" class="form-label">Password:</label>
            <input type="password" class="form-control rounded-pill" id="createpwd" placeholder="Enter password" name="createpswd" required>
          </div>
          <div class="mb-3">
            <label for="pwd" class="form-label">Confirm Password:</label>
            <input type="password" class="form-control rounded-pill" id="createpwd2" placeholder="Enter password" name="createpswd2" required>
          </div>
...
<div style="display:none"><?php include('php/retd.php');?></div>
 ...
 <div class="d-grid">
  ...
  <div class="row">
      <div class="col">
    <div class="shadow col-sm p-1 m-1 bg-transparent text-dark border border border-primary border- 5 rounded">
